...
const config = {
  ...
  baseUrl: '/recursos-ortodoxos/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'MauriceAC', // Usually your GitHub org/user name.
  projectName: 'Recursos Ortodoxos', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/Mauriceac/recursos-ortodoxos/tree/main/docs',
        },
        blog: {
        ...
        links: [
          {
            ...
            items: [
              {
                label: 'Contact',
                href: 'mailto:maurice.ac@gmail.com'
              },
            ],
          },
          // {
